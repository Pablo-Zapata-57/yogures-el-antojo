    ...
    return (<header className="sticky top-0 z-40 w-full backdrop-blur-md bg-background/80 border-b border-border/50">
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <a href="/#sabores" className="text-foreground/80 hover:text-primary transition-smooth">Sabores</a>          <Link to="/blog" className="text-foreground/80 hover:text-primary transition-smooth">Blog</Link>          <a href="/#contacto" className="text-foreground/80 hover:text-primary transition-smooth">Contacto</a>
        </nav>
